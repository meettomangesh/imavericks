...
if( !class_exists( 'WPLLC_MCE_Shortcode_list' ) ) {
	define( 'WPLLC_TMCE_URL', plugin_dir_url( __FILE__ ) );
	class WPLLC_MCE_Shortcode_list {
...
/*		public static function init() {
			return self::WPLLC_MCE_Shortcode_list();
		}*/
		/**
		 * @return WPLLC_MCE_Shortcode_list
		 */
		public static function getInstance() {
			if ( ! self::$_instance ) {
				self::$_instance = new WPLLC_MCE_Shortcode_list();
			}
		...
		function add_mce_plugin( $plugin_array ) {
			$plugin_array['sp_mce_button'] = WPLLC_TMCE_URL . 'sp-mce.js';
			return $plugin_array;
		}
	...
	WPLLC_MCE_Shortcode_list::getInstance();
}
